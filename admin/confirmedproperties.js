...
$(function() {
	...
	if(username) {
		...
		+ "From PROPERTY AS P Where ApprovedBy IS NOT NULL";
		...
		//query database and get all 
			...
			if(searchterm) {
				...
				if(searchtype == "Name") {
					...
					sql = "Select *, (Select Count(*) From VISIT AS V Where P.PropID = V.PropID) AS Visits, (Select AVG(VI.Rating) From VISIT AS VI Where P.PropID = VI.PropID) AS AvgRating From PROPERTY AS P Where PROPTYPE='"+ searchterm +"' AND ApprovedBy IS NOT NULL";
